...
<style>
    ...
    .hero-carousel-section {
        overflow: hidden;
        min-height: 500px !important; /* Altura sincronizada con las imágenes */
    ...
    .carousel-item {
        ...
        background-position: center top; /* Cambiado de center a center top para no cortar cabezas */
        min-height: 500px !important; /* Aumentar un poco para que se vea más imagen */
...
<section class="hero-carousel-section position-relative">
    <div id="servicesCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner">
            <!-- Slide 1 -->
            <div class="carousel-item active" style="background-image: linear-gradient(to right, rgba(0, 24, 48, 0.6), rgba(0, 95, 163, 0.1)), url('assets/img/2principal.jpeg'); background-size: cover; background-position: center top; min-height: 500px;">
                <div class="container py-5 d-flex align-items-center" style="min-height: 500px;">
            ...
            <!-- Slide 2 -->
            <div class="carousel-item" style="background-image: linear-gradient(to right, rgba(0, 24, 48, 0.6), rgba(0, 162, 255, 0.1)), url('assets/img/3principal.jpeg'); background-size: cover; background-position: center top; min-height: 500px;">
                <div class="container py-5 d-flex align-items-center" style="min-height: 500px;">
                    <div class="text-white animate__animated animate__fadeInLeft">
            ...
            <!-- Slide 3 -->
            <div class="carousel-item" style="background-image: linear-gradient(to right, rgba(0, 24, 48, 0.6), rgba(0, 162, 255, 0.1)), url('assets/img/4principal.jpeg'); background-size: cover; background-position: center top; min-height: 500px;">
                <div class="container py-5 d-flex align-items-center" style="min-height: 500px;">
                    <div class="text-white animate__animated animate__fadeInLeft">
