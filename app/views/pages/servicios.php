...
<section class="hero-carousel-section position-relative">
    <div id="servicesCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner">
            <!-- Slide 1 -->
            <div class="carousel-item active" style="background-image: linear-gradient(to right, rgba(0, 24, 48, 0.8), rgba(0, 95, 163, 0.3)), url('assets/img/carrusel4.jpeg'); background-size: cover; background-position: center; min-height: 450px;">
                <div class="container py-5 d-flex align-items-center" style="min-height: 450px;">
            ...
            <!-- Slide 2 -->
            <div class="carousel-item" style="background-image: linear-gradient(to right, rgba(0, 24, 48, 0.8), rgba(0, 162, 255, 0.3)), url('assets/img/carrusel5.jpeg'); background-size: cover; background-position: center; min-height: 450px;">
                <div class="container py-5 d-flex align-items-center" style="min-height: 450px;">
                    <div class="text-white animate__animated animate__fadeInLeft">
            ...
            <!-- Slide 3 -->
            <div class="carousel-item" style="background-image: linear-gradient(to right, rgba(0, 24, 48, 0.8), rgba(0, 162, 255, 0.3)), url('assets/img/1principal.jpeg'); background-size: cover; background-position: center; min-height: 450px;">
                <div class="container py-5 d-flex align-items-center" style="min-height: 450px;">
                    <div class="text-white animate__animated animate__fadeInLeft">
