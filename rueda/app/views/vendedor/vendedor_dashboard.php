                        ...
                        <?php foreach ($ruedas as $rd): ?>
                            ...
                            <?php if (!$ya_inscrito): ?>
                                ...
                                <div class="bg-gradient-to-br from-white to-gray-50/50 p-5 rounded-3xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.01)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all duration-300">
                                    ...
                                    <div class="mt-4">
                                        <?php if ($esPermanente): ?>
                                            <a href="index.php?controlador=vendedor&accion=verMisOfertas&id=<?php echo $rd['id']; ?>" class="w-full block text-center text-xs bg-emerald-600 hover:bg-emerald-700 text-white py-2.5 rounded-full font-black shadow-md shadow-emerald-500/10 hover:shadow-lg transition-all duration-300">
